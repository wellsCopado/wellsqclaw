...
# 核心依赖 + 嵌入式后端依赖
requirements = python3, kivy, kivymd, loguru, requests, aiohttp, websockets, pillow, numpy, multidict, yarl, fastapi, uvicorn, starlette, pydantic, feedparser, httpx, h11, anyio, sniffio, certifi, idna, annotated-types, annotated-doc, typing_extensions, click
